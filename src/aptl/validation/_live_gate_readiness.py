...
def _container_health_diagnostics(
    ...
    A declared VM must have a running container. Run-to-completion service state
    is represented by native materialization concerns with readback evidence,
    not Docker restart metadata on a stopped container.
    """
