"""Shared provider-readback helpers for RAES realization observation."""
...
# wiring in the author vocabulary (``generated_artifacts.X``). raes
...
def artifact_spec(
    ...
    """Render the RAES concern value observed for a generated artifact."""
...
def volume_spec(volume: DeploymentPersistentVolumeRealization) -> dict[str, object]:
    """Render the RAES concern value observed for a persistent volume."""
