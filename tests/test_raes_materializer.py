...
The planner turns a node's declared RAES desired state into an ordered list of
...
class TestPlanNodeMaterialization:
    ...
    def test_planner_is_product_agnostic(self):
        ...
        # proves RAES can compose an arbitrary conformant SDL.
        runtime = RuntimeConfiguration(
...
class TestPackageFamilyBaseSelection:
    ...
    def test_non_service_base_is_family_aware(self):
        assert base_image_for_os("linux", "", family="debian") == "debian:13-slim"
