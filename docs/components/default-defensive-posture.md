...
- A gap that **blue closed during the run** (for example, enabled an
  active-response block), and
- A gap that **was already wired but inactive** (for example, the
...
- **WEAKNESS BY DESIGN**: the *target's* intentional vulnerability.
  ...
  attack. Blue defends *against* them by hardening (for example, rotating to
...
- IDS-only mode. Suricata runs with `command: ["-c",
  ...
  ([`docker-compose.yml:199`](https://github.com/Brad-Edwards/aptl/blob/main/docker-compose.yml))—no NFQ, no
  ...
  Suricata.
- Loaded rule files
  ([`config/suricata/suricata.yaml:97-104`](https://github.com/Brad-Edwards/aptl/blob/main/config/suricata/suricata.yaml)):
...
- `local.rules` ships **16 `alert` rules and zero `drop` rules**
  ([`config/suricata/rules/local.rules`](https://github.com/Brad-Edwards/aptl/blob/main/config/suricata/rules/local.rules)).
...
- Tag MISP attributes with `aptl:enforce`. The sync service
  ([`src/aptl/services/misp_suricata_sync/main.py`](https://github.com/Brad-Edwards/aptl/blob/main/src/aptl/services/misp_suricata_sync/main.py))
...
| Surface | File |
|---|---|
| IDS-only invocation | [`docker-compose.yml:199`](https://github.com/Brad-Edwards/aptl/blob/main/docker-compose.yml) |
...
- Manager loads bundled Wazuh rules plus seven custom rule files via
  `<rule_include>` in
  [`config/wazuh_cluster/wazuh_manager.conf:356-368`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf).
- Two rule directories are watched
  ([`config/wazuh_cluster/wazuh_manager.conf:345-346`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf)):
...
- Decoders for postgresql and samba ship at
  [`config/wazuh_cluster/{postgresql,samba}_decoders.xml`](https://github.com/Brad-Edwards/aptl/tree/main/config/wazuh_cluster).
...
- **`zzz_purple_loop.xml` ships absent from the repo by design.** It
  ...
  [`mcp/mcp-indexer/docker-lab-config.json:49-72`](https://github.com/Brad-Edwards/aptl/blob/main/mcp/mcp-indexer/docker-lab-config.json).
...
| Surface | File |
|---|---|
| Rule include order | [`config/wazuh_cluster/wazuh_manager.conf:356-368`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf) |
| Hot rule directory | [`config/wazuh_cluster/wazuh_manager.conf:345-346`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf) |
| Custom rule files | [`config/wazuh_cluster/*.xml`](https://github.com/Brad-Edwards/aptl/tree/main/config/wazuh_cluster) |
| Custom decoders | [`config/wazuh_cluster/*_decoders.xml`](https://github.com/Brad-Edwards/aptl/tree/main/config/wazuh_cluster) |
...
- Five `<active-response>` blocks are wired in the manager config and
  **all five ship `<disabled>yes</disabled>`**
  ([`config/wazuh_cluster/wazuh_manager.conf:262-304`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf)):
...
- All five reference the `aptl-firewall-drop` wrapper command (declared
  at
  [`wazuh_manager.conf:229-234`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf))—
...
- Whitelist file
  ([`config/wazuh_cluster/etc/lists/active-response-whitelist`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/etc/lists/active-response-whitelist))
...
- Author additional blocks pointing at custom rule IDs (for example, new
...
| Surface | File |
|---|---|
| AR block declarations (all disabled) | [`config/wazuh_cluster/wazuh_manager.conf:262-304`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf) |
| AR command declaration | [`config/wazuh_cluster/wazuh_manager.conf:229-234`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf) |
| Wrapper script | [`containers/_wazuh-agent/aptl-firewall-drop.sh`](https://github.com/Brad-Edwards/aptl/blob/main/containers/_wazuh-agent/aptl-firewall-drop.sh) |
| Kali whitelist | [`config/wazuh_cluster/etc/lists/active-response-whitelist`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/etc/lists/active-response-whitelist) |
...
- An optional seed script
  ([`scripts/seed-misp.sh`](https://github.com/Brad-Edwards/aptl/blob/main/scripts/seed-misp.sh)) creates an
  ...
  [`scripts/seed-prime.sh`](https://github.com/Brad-Edwards/aptl/blob/main/scripts/seed-prime.sh), which is
...
- The `aptl-misp-suricata-sync` daemon
  ...
  [`src/aptl/services/misp_suricata_sync/config.py:150`](https://github.com/Brad-Edwards/aptl/blob/main/src/aptl/services/misp_suricata_sync/config.py)).
...
- If MISP is briefly unreachable, the sync service preserves
  ...
  ([`src/aptl/services/misp_suricata_sync/main.py:74-75`](https://github.com/Brad-Edwards/aptl/blob/main/src/aptl/services/misp_suricata_sync/main.py))
...
- Wazuh declares an `<integration>` block forwarding level-≥10 alerts
  to Shuffle
  ([`config/wazuh_cluster/wazuh_manager.conf:316-320`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf)).
- The integration is gated by a **runtime-written webhook URL**. The
  custom forwarder script
  ([`config/wazuh_cluster/custom-shuffle:3`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/custom-shuffle))
...
- The seed flow runs in two scripts:
  1. [`scripts/seed-shuffle.sh:265-266`](https://github.com/Brad-Edwards/aptl/blob/main/scripts/seed-shuffle.sh)
  ...
  2. [`scripts/seed-prime.sh:165-169`](https://github.com/Brad-Edwards/aptl/blob/main/scripts/seed-prime.sh)
...
| Surface | File |
|---|---|
| Wazuh→Shuffle forwarder (declaration) | [`config/wazuh_cluster/wazuh_manager.conf:316-320`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf) |
| Forwarder script (gated by webhook file) | [`config/wazuh_cluster/custom-shuffle`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/custom-shuffle) |
| Workflow seed script | [`scripts/seed-shuffle.sh`](https://github.com/Brad-Edwards/aptl/blob/main/scripts/seed-shuffle.sh) |
| Prime master seed | [`scripts/seed-prime.sh`](https://github.com/Brad-Edwards/aptl/blob/main/scripts/seed-prime.sh) |
...
| Surface | File |
|---|---|
| Wazuh→Shuffle→TheHive integration | [`config/wazuh_cluster/wazuh_manager.conf:316-320`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf) |
...
([`containers/ad/provision-users.sh`](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh))
seeds these intentional vulnerabilities:

| Surface | What ships | Line |
|---|---|---|
| Weak password—`michael.thompson` | trivial seasonal pattern (string in source) | [65](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh) |
| Weak password—`jessica.williams` | trivial dictionary pattern (string in source) | [82](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh) |
| Default-issued—`contractor.temp` | over-privileged contractor account with default password (string in source) | [122-127](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh) |
| Stale account—`former.employee` | unrevoked account with old password (string in source) | [130](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh) |
| Over-privilege—`emily.chen` | DevOps account in `Domain Admins` | [62](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh) |
| Over-privilege—`svc-backup` | service account in `Domain Admins` | [119](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh) |
| Kerberoastable—`svc-sql` | SPN set on `MSSQLSvc/db.techvault.local` | [104-105](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh) |
| Kerberoastable—`svc-web` | SPN set on `HTTP/webapp.techvault.local` | [112](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh) |
...
([`containers/ad/provision-users.sh:135-138`](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh)):
...
([`containers/ad/setup-ad.sh:21-28`](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/setup-ad.sh))
...
([`containers/ad/Dockerfile`](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/Dockerfile))—and
...
([`containers/ad/provision-users.sh:143-150`](https://github.com/Brad-Edwards/aptl/blob/main/containers/ad/provision-users.sh)).
...
- *Couple to enforcement:* enable the `301002` AD Kerberos
  ...
  [`config/wazuh_cluster/wazuh_manager.conf:289-295`](https://github.com/Brad-Edwards/aptl/blob/main/config/wazuh_cluster/wazuh_manager.conf))
...
Four Docker bridges
([`docker-compose.yml:1357-1398`](https://github.com/Brad-Edwards/aptl/blob/main/docker-compose.yml)):
...
| Surface | File |
|---|---|
| Network bridge definitions | [`docker-compose.yml:1357-1398`](https://github.com/Brad-Edwards/aptl/blob/main/docker-compose.yml) |
| Per-service network attachments | [`docker-compose.yml`](https://github.com/Brad-Edwards/aptl/blob/main/docker-compose.yml) (per service block) |
