...
| Current user and authoring guidance | `README.md`, `docs/deployment.md`, `docs/index.md`, `docs/reference/cli.md`, `docs/reference/techvault-scenario-overview.md`, `docs/sdl/index.md`, `docs/sdl/techvault-curated-variants.md`, `docs/testing/smoke-test-plan.md` | Treat `docs/sdl/index.md` as the exemplar: companion authoring and format links are separate from the APTL-owned operator catalog and runtime section. Qualify nearby catalog prose as APTL startup selection when context is not explicit. |
...
| Current architecture guidance | `docs/architecture/issue-1000-manual-release-qa-preflight.md`, `docs/architecture/issue-1002-wazuh-api-tls-warmup-preflight.md`, `docs/architecture/issue-589-scenario-pack-capture-ownership-preflight.md`, `docs/architecture/issue-601-participant-demonstration-preflight.md`, `docs/architecture/issue-851-first-time-user-docs-preflight.md`, `issue-591-scenario-pack-capture-asset-ownership-preflight.md`, `issue-866-techvault-realization-contract-preflight.md`, `issue-875-scenario-content-declaration-preflight.md`, `issue-878-scenario-verification-plugin-seam-preflight.md`, `issue-912-misp-redis-post-realization-mutation-preflight.md`, `issue-913-shuffle-post-realization-mutation-preflight.md`, `issue-934-rename-boundary-preflight.md`, `issue-949-orborus-control-authority-preflight.md`, `issue-951-fresh-env-pack-start-preflight.md`, `issue-957-wazuh-attestation-evidence-credentials-preflight.md`, `issue-970-generic-lab-lifecycle-preflight.md`, `issue-956-sdl-runtime-authority-materialization-preflight.md`, `issue-980-pack-adapter-install-seam-preflight.md`, `issue-985-owned-lab-fixture-preflight.md`, `issue-992-backend-observability-ownership-preflight.md`, `issue-1006-container-base-images-preflight.md` | Reuse their ownership, admission, realization, validation, and historical-identity decisions. Do not create a second terminology or pack-ownership model. |
| Owned test fixture pack | `docs/testing/lab-fixture-pack.md` | The fixture is a test input APTL admits through the production resolver. It is not a released environment pack, an APTL startup-catalog entry, or a product scenario. |
