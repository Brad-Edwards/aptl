...
- IMPLEMENTS → DOCUMENTATION `docs/architecture/issue-591-scenario-pack-capture-asset-ownership-preflight.md` (Scenario-pack capture asset ownership and placement decision)
