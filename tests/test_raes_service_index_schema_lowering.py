...
The TechVault 5.1 pack now initializes Cortex through its native initializer,
so this retained APTL capability uses a typed planner-resource fixture for the
portable service-materialization contract.
"""
    ...
    return PlannedResource(
        ...
        payload={
            ...
            "service_materialization": {
                ...
                "canonical_field_schema_digest": canonical_field_schema_digest(
                    field_semantics
                ),
            },
        },
