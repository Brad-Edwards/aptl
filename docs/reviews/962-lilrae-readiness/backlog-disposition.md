...
| [#880: Move TechVault content out of APTL and consume it as a pack](https://github.com/Brad-Edwards/aptl/issues/880) | Partly delivered: external env-pack admission exists. Keep residual content extraction, released packaging, stale static paths and advanced install parity. |
