"""Participant action helpers for the APTL RAES runtime."""
...
class ParticipantActionExecution:
    """Participant action result projected into RAES snapshot surfaces."""
...
def drive_participant_action(
    ...
    *,
    ...
    """Drive the configured participant action and emit RAES evidence surfaces."""
