...
APTL's participant runtime is intentionally narrow: it exposes the RAES
...
from aptl.backends.raes_participant_support import (
...
class AptlParticipantRuntime:
    ...
    def initialize(
        ...
        if action_result is not None:
            ...
            # the snapshot carries, AND be unique — RAES enforces all three. The
    ...
    def admit_action(
        ...
        against the participant's live episode, per the RAES participant
    ...
    def _store_episode(
        ...
        # any carrier holds, and RAES rejects a changed address outside the
