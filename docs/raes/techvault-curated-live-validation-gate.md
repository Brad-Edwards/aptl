...
- `participant-action.json` (`techvault-attacker-target` only): the RAES
...
```bash
docs/raes/techvault-curated-live-validation-gate/run-curated-live-proof.sh techvault-defensive-min
```
