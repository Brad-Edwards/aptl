...
The Scenario combines 19 specification sections covering
who (entities, accounts, agents), what (nodes, features,
vulnerabilities, content), when (scripts, stories, events),
and experiment-relevant how (scoring pipeline, conditions,
...
class Scenario(SDLModel):
    ...
    A YAML document with up to 19 named sections. Only ``name``
