...
were removed after the ADR-035 RAES SDL cutover.
...
5. Start the lab through `aptl.backends.raes.start_raes_scenario()`.
...
helper for the RAES orchestrator's workflow result/history records. It is not a
