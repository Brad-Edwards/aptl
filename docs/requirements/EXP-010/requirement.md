...
- IMPLEMENTS → CODE_FILE `src/aptl/core/evidence/adapters/techvault.py` (Bounded TechVault source validation and evidence shaping)
- IMPLEMENTS → CODE_FILE `src/aptl/core/evidence/adapters/techvault_native.py` (Backend-native Cortex, Suricata, and Wazuh acquisition)
