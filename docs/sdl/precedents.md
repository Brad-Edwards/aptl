...
The 14 base sections are a direct port of the [OCR SDL](https://github.com/Open-Cyber-Range/SDL-parser) v0.21.2 from Rust to Python/Pydantic. The OCR SDL was developed by the Norwegian Cyber Range (CR14/NTNU).
...
| Entity | `Entity` (recursive) | Direct port |
