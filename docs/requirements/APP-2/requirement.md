...
- IMPLEMENTS → CODE_FILE `src/aptl/appliance/inputs.py` (Canonical full-TechVault input and profile assembly)
- IMPLEMENTS → CODE_FILE `src/aptl/workbench/dispatch.py` (Server-side capability admission)
